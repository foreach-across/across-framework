...
/**
 * Registers the auto configuration package for the dynamic application module.
 *
 * @author Arne Vandamme
 * @since 3.0.0
 */
@Configuration
class ApplicationModuleAutoConfigurationPackage implements AcrossBootstrapConfigurer
{
	@Override
