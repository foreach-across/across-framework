...
[horizontal]
context:: Blablablabladfsdfsdf
sdfsdjklf qsdklfjsdlkfjlqksdjflkdsq
...
==== Common dependencies
Across is directly tied to Spring framework and all artifacts come with a set of curated dependencies.  Applications built on top of
Across should either manage the dependencies manually by fixing the versions or let the modules pull in the required
