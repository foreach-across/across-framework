...
* several changes installers
** installer context (never web)
** installers are beans - support all conditionals
** InstallerMetaData class added - InstallerSettings refactored - installers should no longer be instances
