...
import com.foreach.across.test.modules.web.it.modules.cors.CorsModule;
 ...
 */
@ContextConfiguration(classes = ITCorsSupported.Config.class)
public class ITCorsSupported extends AbstractWebIntegrationTest
{
