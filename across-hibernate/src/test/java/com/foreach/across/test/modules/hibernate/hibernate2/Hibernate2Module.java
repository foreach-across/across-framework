...
public class Hibernate2Module extends AcrossModule implements HasHibernatePackageProvider
{
	@Override
	...
	public HibernatePackageProvider getHibernatePackageProvider( AcrossHibernateModule hibernateModule ) {
		return new PackagesToScanProvider( "com.foreach.across.test.modules.hibernate.hibernate2" );
	}
}
